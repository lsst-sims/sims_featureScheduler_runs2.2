...
def optimize_ddf_times(ddf_name, ddf_RA, ddf_grid,
    ...
    sequence_length : `float`
        The amount of time a sequence is expected to take. Used to demand there be enough time until 
        -18 degrees morning twilight. (hours)
    """
    sun_limit = np.radians(sun_limit)

    sequence_length = sequence_length / 24.  # Hours to days
    ...
    # set a sun, airmass, sky masks, time left in night mask
