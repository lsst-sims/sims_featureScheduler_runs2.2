...
def generate_blobs(nside, nexp=2, exptime=30., filter1s=['u', 'u', 'g', 'r', 'i', 'z', 'y'],
                   ...
                   stayfilter_weight=3., template_weight=12., u_template_weight=12., footprints=None, u_nexp1=True,
    ...
    for filtername, filtername2 in zip(filter1s, filter2s):
        ...
        if filtername2 is not None:
            ...
            bfs.append((bf.N_obs_per_year_basis_function(filtername=filtername, nside=nside,
                                                         ...
                                                         n_obs=n_obs_template, season=season,
                                                         season_start_hour=season_start_hour,
                                                         season_end_hour=season_end_hour), template_weights[filtername]))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--template_weight", type=float, default=12)
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + '_'
    file_end = 'templatew%i_v2.2_' % template_weight
    ...
    blobs = generate_blobs(nside, nexp=nexp, footprints=footprints, mjd_start=conditions.mjd_start,
                           good_seeing_weight=gsw, u_template_weight=template_weight)
