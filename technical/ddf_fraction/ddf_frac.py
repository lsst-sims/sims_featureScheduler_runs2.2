...
def ddf_surveys(detailers=None, season_frac=0.2, sequence_limit=286):
    obs_array = generate_ddf_scheduled_obs(season_frac=season_frac, sequence_limit=sequence_limit)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sequence_limit", type=int, default=286)
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + '_'
    file_end = 'sl%i_v2.2_' % sequence_limit
    ...
    ddfs = ddf_surveys(detailers=details, season_frac=ddf_season_frac, sequence_limit=sequence_limit)
