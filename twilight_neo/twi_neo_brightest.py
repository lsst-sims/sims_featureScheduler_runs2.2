...
def generate_twilight_neo(nside, night_pattern=None, nexp=1, exptime=15,
                          ...
                          filters='riz', n_repeat=3, sun_alt_limit=-14.5):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--neo_repeat", type=int, default=3)
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + '_'
    file_end = 'repeat%i_%s_np%i_v2.2_' % (neo_repeat, neo_filters, night_pattern)
    ...
    neo = generate_twilight_neo(nside, night_pattern=night_pattern, filters=neo_filters, n_repeat=neo_repeat)
