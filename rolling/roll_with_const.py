...
from rubin_sim.scheduler.utils import (Sky_area_generator, Footprint, Step_slopes,
                                       slice_quad_galactic_cut, Footprints)
...
def make_rolling_footprints(
    ...
    all_slopes = [start + np.roll(rollings[roll_indx], i).tolist() + end for i in range(nslice)]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--roll_indx", type=int, default=0)
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + '_'
    file_end = 'roll_indx%i_v2.2_' % roll_indx
    ...
    footprints = make_rolling_footprints(fp_hp=footprints_hp, mjd_start=conditions.mjd_start,
                                         ...
                                         nside=nside, wfd_indx=wfd_indx, roll_indx=roll_indx)
